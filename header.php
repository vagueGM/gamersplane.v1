...
<?	if (!MODAL) { ?>
<header id="bodyHeader" ng-controller="header" class="<?=PAGE_ID == 'home'?'large ':''?><?=isset($contentClasses) && array_search('fullWidthBody', $contentClasses) >= 0?'fullWidthBody ':''?>">
	<div id="headerBG"></div>
	<div class="bodyContainer">
		...
		<div id="mainMenuContainer"><div>
			...
			<div id="mobileMenuHamburger"><a href=""></a><hamburger-menu></hamburger-menu></a></div>
			<ul id="mainUserMenu">
